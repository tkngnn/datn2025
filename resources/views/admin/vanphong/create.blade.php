                                ...
                                <div class="card-body">
                                    ...
                                    <!-- Mã văn phòng (không cho nhập) -->
                                            ...
                                            <label class="input-label">Mã văn phòng</label>
                                                <input type="text" id="maVanPhong" class="form-control" value="{{ $nextId }}" disabled>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6">
                                            ...
                                            <label class="input-label">Diện tích</label>
                                                ...
                                                <input type="text" class="form-control" name="dien_tich" id="dien_tich" placeholder="Nhập diện tích" value="{{ old('dien_tich') }}">
                                    ...
                                    <label class="col-sm-3 col-form-label input-label">Tiện ích</label>
                                        <textarea class="form-control" name="tien_ich" rows="3" value="{{ old('tien_ich') }}" placeholder="Thông tin tiện ích nếu có..."></textarea>
                                    ...
                                    <label class="col-sm-3 col-form-label input-label">Mô tả</label>
                                        <input type="hidden" name="mo_ta" value="{{ old('mo_ta') }}" id="hiddenDescription">
