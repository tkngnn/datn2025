                        ...
                        <div class="col-sm-6 col-md-4 mb-3 mb-sm-0">
                            <form>
                                ...
                                <div class="input-group input-group-merge input-group-flush">
                                    ...
                                    <input id="datatableSearch" type="search" value="{{ request('vanphong') }}"
                                        class="form-control" placeholder="Tìm kiếm văn phòng"
                                        aria-label="Tìm kiếm văn phòng">
                                </div>
                                <!-- End Search -->
                            </form>
                        </div>
                                ...
                                <div class="d-flex flex-wrap gap-2">
                                    ...
                                    @if (request('dien_tich_min') || request('dien_tich_max'))
                                        <span class="badge badge-soft-info" style="padding: .8rem .8rem;">
                                            Diện tích:
                                            {{ request('dien_tich_min') ?? '...' }} -
                                            {{ request('dien_tich_max') ?? '...' }} m²
                                        </span>
                                    @endif
                                    ...
                                    @if (request('trang_thai'))
                                        <span class="badge badge-soft-warning" style="padding: .8rem .8rem;">
                                            Trạng thái:
                                            {{ request('trang_thai') == 'Dang trong' ? 'Đang trống' : 'Đã thuê' }}
                                        </span>
                                    @endif
                                </div>
                            </div>
                                    ...
                                    <form method="GET" action="{{ route('admin.vanphong.index') }}">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <input type="text" name="dien_tich_min"
                                                    class="form-control format-number" placeholder="Từ"
                                                    value="{{ request('dien_tich_min') }}">
                                                <input type="text" name="dien_tich_max"
                                                    class="form-control format-number" placeholder="Đến"
                                                    value="{{ request('dien_tich_max') }}">
                                            </div>
                                        </div>
                                        ...
                                        @if (!$title)
                                            <div class="form-group">
                                                ...
                                                <select name="trang_thai" id="trang_thai"
                                                    ...
                                                    <option value="">-- Tất cả --</option>
                                                    <option value="dang trong"
                                                        {{ request('trang_thai') == 'dang trong' ? 'selected' : '' }}>Đang
                                                        trống</option>
                                                    <option value="da thue"
                                                        {{ request('trang_thai') == 'da thue' ? 'selected' : '' }}>Đã thuê
                                                    </option>
                                                </select>
                                            </div>
                                        @endif
                    ...
                    <tbody>
                        @foreach ($henxems as $henxem)
                            <tr>
                                ...
                                <td>
                                    <a href="javascript:;" class="d-block btn-xem-toanha text-body"
