...
@section('content')
    <main id="content" role="main" class="main">
        <form action="{{ route('admin.vanphong.update', $vanphong->ma_van_phong) }}" method="POST" id="formVanPhong"
                        ...
                        <div class="card mb-3 mb-lg-5">
                            ...
                            <div class="card-body">
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="maVanPhong" class="form-control"
                                                value="{{ $vanphong->ma_van_phong }}" disabled>
                                        </div>
                                    </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <input type="text" class="form-control" name="dien_tich" id="dien_tich"
                                                    ...
                                                    value="{{ old('dien_tich', $vanphong->dien_tich) }}">
                                                <div class="input-group-append">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <input type="text" class="form-control" name="gia_thue" id="gia_thue"
                                                    ...
                                                    value="{{ number_format(old('gia_thue', $vanphong->gia_thue), 0, ',', '.') }}">
                                                <div class="input-group-append">
                                                ...
                                                @foreach ($vanphong->getMedia('anh_van_phong') as $media)
                                                    <div class="preview-image" data-existing-image="{{ $media->id }}">
                                                        <img src="{{ asset('storage/' . $media->id . '/' . $media->file_name) }}"
                                                            alt="Preview"> <button type="button" class="remove-btn"
                                                            onclick="removeExistingImage(this, '{{ $media->id }}')">X</button>
                                                    </div>
                                                @endforeach
                                            @endif
                                        </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="hidden" name="mo_ta" value="{{ old('mo_ta', $vanphong->mo_ta) }}"
