            ...
            <tbody>
              @foreach ($henxems as $henxem)
                <tr>
                  ...
                  <td class="text-break px-3">{{ $henxem->ma_van_phong }}</td>
                  <td class="text-break px-3">{{ $henxem->ngay_hen }}</td>
                  <td class="text-break px-3">{{ $henxem->ghi_chu }}</td>
                  <td class="text-break px-3">
                    @if ($henxem->trang_thai === "Da hoan thanh")
